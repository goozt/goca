...
func CreateServerCertTemplate(subject CertSubject) CertTemplate {
...
func CreateServerCertificate(template CertTemplate, interCaCert *x509.Certificate, interCaKey crypto.Signer, priv crypto.Signer) (*x509.Certificate, error) {
	pub := priv.Public()
